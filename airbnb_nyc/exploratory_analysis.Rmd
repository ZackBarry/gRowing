...
We'll be predicting price as a function of most of the features in the original dataset.
...
dmy <- dummyVars("~ .", data = to_model, fullRank = T)  # fullRank = T makes it so that there are 4 columns for a 5 level variable
...
h2o_pred <- h2o.predict(h2o_gbm, test_h2o) %>% as.vector()
