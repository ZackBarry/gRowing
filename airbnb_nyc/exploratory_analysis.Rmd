...
```{r}
# don't include neighbourhood, lat, or long in model - highly correlated with the response variable, neighbourhood_group
to_model <- dataset %>%
...
train_h2o["neighbourhood_group"] <- as.factor(train_h2o["neighbourhood_group"])
train_h2o["room_type"] <- as.factor(train_h2o["room_type"])

test_h2o <- as.h2o(test)
test_h2o["neighbourhood_group"] <- as.factor(test_h2o["neighbourhood_group"])
test_h2o["room_type"] <- as.factor(test_h2o["room_type"])

response <- "neighbourhood_group"
