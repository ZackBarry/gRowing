...
rsquared_unlog(pred_log_price, true_log_price)
```

Start-up H2O and initialize H2O data:
```{r}
library(h2o)
...
mse_unlog(h2o_pred, true_log_price)
rmse_unlog(h2o_pred, true_log_price)
rsquared_unlog(h2o_pred, true_log_price)
```
