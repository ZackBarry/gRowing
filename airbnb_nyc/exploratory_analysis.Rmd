...
sprintf("Baseline MSE: %f", mse_unlog(pred_log_price, true_log_price))
sprintf("Baseline RMSE: %f", rmse_unlog(pred_log_price, true_log_price))
sprintf("Baseline R^2: %f", rsquared_unlog(pred_log_price, true_log_price))
```
...
sprintf("Default MSE: %f", mse_unlog(h2o_pred, true_log_price))
sprintf("Default RMSE: %f", rmse_unlog(h2o_pred, true_log_price))
sprintf("Default R^2: %f", rsquared_unlog(h2o_pred, true_log_price))
```
